...
import {globalUserUrls, mockFetch, partnerUserUrls} from "./utils/mockFetch.service.ts";
import {MapOf} from "../modules/shared/types/shared.types.ts";
import {expect} from "vitest";
import {debugText} from "./utils/testUtils.ts";

async function renderSearch(fetchUrls:MapOf<object>):Promise<void> {
    mockFetch(fetchUrls)
