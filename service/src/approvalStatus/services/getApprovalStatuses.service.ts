...
export function getApprovalsUrl(selectedFilters: SelectedFilters, selectedIds:MechanismMetadata[]=null): string {
...
export function getApprovalStatuses(selectedFilters: SelectedFilters, selectedIds:MechanismMetadata[]=null){
